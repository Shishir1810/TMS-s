...
//reset password
    ...
    public function sendResetLink(Request $request){
      ...
      $body = "We have received a request to reset the password for <b>Tourism World </b> account associated with ".$request->email.".you can reset your password by clicking on the link below";

      \Mail::send('website.reset.email-forgot',['action_link'=> $action_link,'body'=>$body],function($message)use($request){
          $message->from('adriankhanshishir@gmail.com','Tourism World');
