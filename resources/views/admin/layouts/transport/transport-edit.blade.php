  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationCustom01">Transport name</label>
       <input name="TransportName" value="{{$transport->transportName}}"
      class="form-control" id="validationCustom01" placeholder="Tour Name"  required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input name="TransportType" value="{{$transport->transportType}}"
    ...
    <div class="col-md-4 mb-3">
      <label for="validationCustomUsername">location</label>
        ...
        <input name="Location"   value="{{$transport->location}}"
